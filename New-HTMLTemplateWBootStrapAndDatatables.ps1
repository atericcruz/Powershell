...
<head>
    <meta charset="utf-8">
    <title>PURE Storage Reports</title>
...
<body>
    <div class="container-fluid">
        <div class="jumbotron text-center">
            <h1 class="h1-reponsive mb-3 blue-text"><strong>PURE Storage Report $(Get-Date -format 'MM-dd-yy hh:mm:ss tt' ) (refreshes 10min)</strong></h1>
        </div>
